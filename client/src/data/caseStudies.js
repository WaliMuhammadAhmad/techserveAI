const CaseStudies = [
  ...
  },
  {
    ...
    solution:
      "Techiserve.ai created a secure cloud pipeline to collect and optimize property management data, ensuring privacy and compliance. Advanced analytics turned raw data into actionable insights, enabling real-time reporting on operations, finances, and investments. The solution became a centralized platform with dynamic dashboards and customizable reports for property managers, executives, and investors. It streamlined workflows, improved decision-making, and enhanced financial oversight, empowering the client to respond quickly to opportunities and challenges.",
  },
  {
    id: 4,
